...
from .views import (
    ...
    CategoryCreateView, CategoryUpdateView, CategoryDeleteView, LeadJsonView, FollowUpCreateView,
...
urlpatterns = [
    ...
    path('<int:pk>/followups/category/', FollowUpCreateView.as_view(), name='lead-followup-create'),
